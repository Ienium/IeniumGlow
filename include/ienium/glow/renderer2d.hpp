...
namespace ienium::glow
{
    ...
    class Renderer2D
    {
      public:
        ...
        void DrawText(const std::string& text, ResourceId font, const Vector2& position, const utils::Color& color = utils::Color::White(),
                      Alignment alignment = CENTER) const;
        ...
        void DrawSprite(const Vector2& size, const Vector2& position, ResourceId texture_id, const utils::Color& tint = utils::Color::White(),
                        const Vector2& texture_scale = Vector2::One(), const Vector2& texture_offset = Vector2::Zero(), float angle = 0) const;
