...
namespace ienium::glow
{
    ...
    struct SpriteRenderCommand : public RenderCommand
    {
        ...
        SpriteRenderCommand (const Vector2& size, const Vector2& position, const utils::Color& tint, const Vector2& texture_scale, const Vector2& texture_offset, float angle)
