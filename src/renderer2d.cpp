...
namespace ienium::glow
{
    class Renderer2D::Impl
    {
      ...
      public:
        ...
        void Shutdown() { renderMemoryManager.Shutdown(); }

        void Clear(const ienium::utils::Color& color) { NOT_YET_IMPLEMENTED; }
        ...
        void SetCamera(const Camera2D& camera) { NOT_YET_IMPLEMENTED; }

        void SetLayer(int layer) { currentLayer = layer; }

        void DrawLine(const Vector2& start, const Vector2& end, const utils::Color& color, float thickness) { NOT_YET_IMPLEMENTED; }

        void DrawLine(const Vector2& start, const Vector2& end, const std::vector<utils::Color>& color_list, float thickness) { NOT_YET_IMPLEMENTED; }
        ...
        void DrawCircle(float radius, const Vector2& position, const utils::Color& color) { NOT_YET_IMPLEMENTED; }

        void DrawTriangle(const Vector2& size, const Vector2& position, const utils::Color& color, float angle) { NOT_YET_IMPLEMENTED; }
        ...
        void DrawRectangle(const Vector2& size, const Vector2& position, const utils::Color& color, float angle) { NOT_YET_IMPLEMENTED; }
        ...
        void DrawEllipse(const Vector2& size, const Vector2& position, const utils::Color& color, float angle) { NOT_YET_IMPLEMENTED; }
        ...
        void DrawSprite(const Vector2& position, ResourceId texture_id) { NOT_YET_IMPLEMENTED; }

        void DrawSprite(const Vector2& size, const Vector2& position, ResourceId texture_id, const utils::Color& tint, const Vector2& texture_scale,
    ...
    void Renderer2D::DrawSprite(const Vector2& size, const Vector2& position, ResourceId texture_id, const utils::Color& tint,
                                const Vector2& texture_scale, const Vector2& texture_offset, float angle) const
    {
